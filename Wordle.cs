...
class Wordle : State {
    ...
    public override void Play() {
        Console.WriteLine("Wordle handles request 1");
        Console.WriteLine("Wordle's game is starting...");
    ...
    public override void NextGame() {
        Console.WriteLine("Wordle handles request 2");
        Console.WriteLine("Worlde is moving to the next game...");
        currentContext.TransitionTo(new HangmanState());
    }
}